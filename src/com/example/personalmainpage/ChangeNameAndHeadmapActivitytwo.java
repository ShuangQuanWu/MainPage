...
public class ChangeNameAndHeadmapActivitytwo extends Activity implements OnClickListener{
	...
	class btn01Listener implements OnClickListener{
		public void onClick(View v){
			...
			intent.setClass(ChangeNameAndHeadmapActivitytwo.this,PersonalmainpageActivity.class);
